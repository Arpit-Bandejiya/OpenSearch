...
public class InternalRemoteRoutingTableService extends AbstractLifecycleComponent implements RemoteRoutingTableService {
    ...
    private final RemoteWritableEntityStore<IndexRoutingTable, RemoteIndexRoutingTable> remoteIndexRoutingTableRemoteWriteableEntity;
    ...
    public InternalRemoteRoutingTableService(
        ...
        this.remoteIndexRoutingTableRemoteWriteableEntity = new RemoteRoutingTableBlobStore<>(
    ...
    public CheckedRunnable<IOException> getAsyncIndexRoutingWriteAction(
        ...
        return () -> remoteIndexRoutingTableRemoteWriteableEntity.writeAsync(remoteIndexRoutingTable, completionListener);
    }
    ...
    public CheckedRunnable<IOException> getAsyncIndexRoutingReadAction(
        ...
        return () -> remoteIndexRoutingTableRemoteWriteableEntity.readAsync(remoteIndexRoutingTable, actionListener);
    }
